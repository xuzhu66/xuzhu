import Vue from 'vue';
import Tips from '@/plugins/template1/tips/tips';
import LoadingBut from '@/plugins/template1/loading/loadingBut';
import MyDialog from '@/plugins/template1/dialog/dialog' // myDialog
import MyLoading from '@/plugins/template1/loading/loading'
