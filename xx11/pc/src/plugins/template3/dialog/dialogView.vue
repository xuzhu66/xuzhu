...
<script>
const UserAgreement = () => import(/* webpackPrefetch: true */ '@/views/template3/common/footer/userAgreement'); // 用户协议
const Respons = () => import(/* webpackPrefetch: true */ '@/views/template3/common/footer/respons'); // 责任
const Exceptions = () => import(/* webpackPrefetch: true */ '@/views/template3/common/footer/exceptions'); // 免责条款
const Privacy = () => import(/* webpackPrefetch: true */ '@/views/template3/common/footer/privacy'); // 用户隐私
const Help = () => import(/* webpackPrefetch: true */ '@/views/template3/common/footer/help'); // 帮助中心
