        ...
        .vip-list-con
            ul
                ...
                li
                    ...
                    align-items center
                    height 50px
                    border_com(1px, solid, border58, bottom)
                    ...
                    span
                        ...
                        &:nth-child(1)
                            flex 2
                            border_com(1px, solid, border58, right)
                        ...
                        &.普通会员:after
                            content ""
                            display block
                            background url("~@img/template2/center/v0.png") center no-repeat
                            width 28px
                            height 25px
                            position absolute
                            top 50%
                        ...
                        &.vip1:after
                            content ""
                            display block
                            background url("~@img/template2/center/v1.png") center no-repeat
                            width 28px
                            height 25px
                            position absolute
                            top 50%
                        ...
                        &.vip2:after
                            content ""
                            display block
                            background url("~@img/template2/center/v2.png") center no-repeat
                            width 28px
                            height 25px
                            position absolute
                            top 50%
                        ...
                        &.vip3:after
                            content ""
                            display block
                            background url("~@img/template2/center/v3.png") center no-repeat
                            width 28px
                            height 25px
                            position absolute
                            top 50%
                        ...
                        &.vip4:after
                            content ""
                            display block
                            background url("~@img/template2/center/v4.png") center no-repeat
                            width 28px
                            height 25px
                            position absolute
                            top 50%
                        ...
                        &.vip5:after
                            content ""
                            display block
                            background url("~@img/template2/center/v5.png") center no-repeat
                            width 28px
                            height 25px
                            position absolute
                            top 50%
                        ...
                        &.vip6:after
                            content ""
                            display block
                            background url("~@img/template2/center/v6.png") center no-repeat
                            width 28px
                            height 25px
                            position absolute
                            top 50%
