        ...
        .join-main(v-show="userInfo.type==3")
            ...
            ul.join-list
                li(v-for="(v,i) in jlist" :key='i')
                    p.joinl-ticon
                        img(:src="require(`@img/template2/join/${v.icon}.png`)")
                    p.joinl-text {{v.text}}
            p.join-button(@click="gotoApply()")
                img(:src="require(`@img/template2/join/button01.png`)")
            .join-foot-banner
                img(:src="joinPic2")
            ...
            p.join-tit
                ...
                span.join-lin
            p.join-fapprove
                img(:src="require(`@img/template2/join/approve.png`)")
...
<script>
import comPagination from "@pon/template2/comPagination"
...
export default {
    ...
    data() {
        return {
            joinPic1: require('@img/template2/join/pic1.png'),
            joinPic2: require('@img/template2/join/pic2.png'),
            jlist:[{
                icon: 'icon01',
                text:'最精确的数据'
            },{
...
.hadAgent
    ...
    .tab-con
        ...
        .tab01
                ...
                .qr-con-unit
                    ...
                    .qr-item
                        ...
                        .qr-btn
                            flex none
                            width 100px
                            bg_img_linear(linear05, linear06)
                            height: 40px;
                            line-height: 40px;
                            text-align: center;
                            border-radius: 20px;
            ...
            .user-money
                ...
                .title
                    ...
                    &:before
                        content ''
                        display block
                        background url("~@img/template2/center/sby.png") center no-repeat
                        width 42px
                        height 23px
                        position absolute
                        left 230px
            ...
            .money-con
                height 360px
                background url("~@img/template2/center/dengjitu.png") right 0px top 0px / contain no-repeat
                padding: 160px 0px;
...
.join-main
    ...
    bg_color(bg69);
    border-radius: 10px;
    border_com(1px, solid, bg61, bottom)
    position relative
    transition all .3s
    padding 20px
    margin-bottom 20px
