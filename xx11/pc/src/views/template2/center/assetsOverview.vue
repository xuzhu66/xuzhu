...
import comDatepicker from "@pon/template2/comDatepicker"
...
.assetsOverview
    ...
    .dialog-con
        .jump-con
            ...
            .success-icon
                background url("~@img/template2/home/success.svg") center / contain no-repeat
                width 60px
                height 60px
                margin 10px auto
                font_color(fc019)
                    ...
                    ul
                        ...
                        li
                            ...
                            &:nth-child(1)
                                ...
                                .item
                                    ...
                                    .photo
                                        ...
                                        border-radius 50%
                                        margin: 0px auto;
                                        background url("~@img/template2/center/user.png") center no-repeat
                                    ...
                                    .item-top
                                        ...
                                        //.vipLevel1
                                        //    background url("~@img/template2/comm/vip0.png") center no-repeat
                                        //
                                        //.vipLevel2
                                        //    background url("~@img/template2/comm/vip1.png") center no-repeat
                                        //
                                        //.vipLevel3
                                        //    background url("~@img/template2/comm/vip2.png") center no-repeat
                                        //
                                        //.vipLevel4
                                        //    background url("~@img/template2/comm/vip3.png") center no-repeat
                                        //
                                        //.vipLevel5
                                        //    background url("~@img/template2/comm/vip4.png") center no-repeat
                                        //
                                        //.vipLevel6
                                        //    background url("~@img/template2/comm/vip5.png") center no-repeat
                                        //
                                        //.vipLevel7
                                        //    background url("~@img/template2/comm/vip6.png") center no-repeat
                            ...
                            &:nth-child(2)
                                ...
                                .icon-user
                                    flex: 1
                                    background url("~@img/template2/center/geren.png") center no-repeat
                                    width 30px
                                    height 30px

                                    &.ok
                                        background url("~@img/template2/center/nameok.png") center no-repeat

                                .icon-card
                                    flex: 1
                                    background url("~@img/template2/center/yinhagk.png") center no-repeat
                                    width 30px
                                    height 30px

                                    &.ok
                                        background url("~@img/template2/center/cardok.png") center no-repeat

                                .icon-phone
                                    flex: 1
                                    background url("~@img/template2/center/shouji.png") center no-repeat
                                    width 30px
                                    height 30px

                                    &.ok
                                        background url("~@img/template2/center/mobileok.png") center no-repeat
