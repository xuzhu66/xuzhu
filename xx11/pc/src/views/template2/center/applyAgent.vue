        ...
        .apply-main(v-show="platformInfo && platformInfo.rebateAgentEnabled")
            ...
            .apply-con
                ...
                van-swipe.t1-banner(:autoplay="3000" :show-indicators="false")
                    van-swipe-item(v-for="(item, index) in washCodeList" :key="index")
...
export default {
    ...
    computed: {
        ...mapState({
            ...
            washCodeList: state => state['homeStore'].washCodeList,
    ...
    methods: {
        ...mapActions({
            ...
            getHotListAction(dispatch, param) {
        ...
        .user-list
            ...
            .item
                ...
                .icon
                    ...
                    &.all
                        background url("~@img/template2/center/daili.png") center no-repeat

                    &.week
                        background url("~@img/template2/center/chukuan.png") center no-repeat

                    &.yesterday
                        background url("~@img/template2/center/xinzeng.png") center no-repeat
