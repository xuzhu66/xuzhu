...
import passWordDialog from "@/views/template2/center/passWordDialog";
import usdtDialog from "@/views/template2/center/user/usdtDialog";
import bankDialog from "@/views/template2/center/user/bankDialog";
export default {
    name: "draw",
    components: {
        comDialog,
