...
import Login from '@/views/template2/login/loginAcount'; // 登录
import Reg from '@/views/template2/login/registIndex'; // 注册
import ForgetPwd from '@/views/template2/login/forgetPwd'; // 忘记密码
import UpdatePwd from '@/views/template2/login/updatePwd'; // 修改密码
import LoginVerif from '@/views/template2/login/loginPhoneCode';
...
export default {
    ...
    data() {
        return {
            isReq: false, // 请求是否完成
            flog: require('@img/template2/home/foot_blogo.png'),
            curtit: "欢迎登录", // 当前标题
            menu: [
                {
                    name: '登录',
