...
import RegAcount from '@/views/template2/login/registAcount'; // 用户账号注册
import RegPhone from '@/views/template2/login/registPhone'; // 手机号码注册
import RegVerif from '@/views/template2/login/registPhoneCode'; // 验证码注册
export default {
    name: 'Register', // 注册
    components: {
