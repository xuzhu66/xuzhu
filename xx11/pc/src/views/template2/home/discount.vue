...
import Notice from '@pon/template2/notice';
            ...
            ul
                ...
                li
                    ...
                    &.active
                        ...
                        &:after
                            after()
                            background url("~@img/template2/home/bg/fenlei.png") center / contain no-repeat
                            width 180px
                            height 1px
        ...
        .discount-right
            ...
            ul
                ...
                li
                    ...
                    &.status1
                        &:after
                            background url("~@img/template2/preferent/pstate0.png") 0px center / 100% no-repeat

                    &.status2
                        &:after
                            background url("~@img/template2/preferent/pstate1.png") 0px center / 100% no-repeat

                    &.status3
                        &:after
                            background url("~@img/template2/preferent/pstate2.png") 0px center / 100% no-repeat

                    &.status4
                        //filter: grayscale(100%)

                        &:after
                            background url("~@img/template2/preferent/pstate3.png") 0px center / 100% no-repeat
