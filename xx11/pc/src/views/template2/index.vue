...
<script>
import Header from '@/views/template2/common/headerIndex'; // 头部
import Footer from '@/views/template2/common/footer/footerIndex'; // 底部
import LoadingDialog from "@/plugins/template2/loadingDialog/loadingDialog"; // 弹出框
import LoginReg from '@/views/template2/login/loginIndex'; // 登录
import Left from '@/views/template2/common/left'; // 左边客服
import DrawDialog from '@/views/template2/center/drawDialog'; // 取款弹窗
import GameDialog from '@/views/template2/game/gameDialog';
import gameStore from "@/store/comstore/game/gameStore"; // 登入游戏状态
import homeStore from "@/store/template2/homeStore";
...
import '@styl/template2/index.styl';
import {mapActions, mapMutations, mapState} from "vuex";
import {getUrlParam} from "@m/utils";
import bannerStore from "@/store/template2/bannerStore"; // 工具类
import Banner from '@pon/template2/homeBanner'; // Banner轮播图片
import activityDialog from '@/views/business/activity/activityDialog'; // 活动弹框
