                ...
                ul
                    ...
                    li
                        .card-list
                            ...
                            .card
                                background url("~@img/template1/center/yinhangk_usdt.png") center / contain no-repeat
                                width: 450px;
                                height: 192px;
                                position relative
                                margin-bottom 36px
                                ...
                                .default
                                    background url("~@img/template1/center/moren.png") center / contain no-repeat
                                    width 75px
                                    height 75px
                                    position absolute
                                    top: 2px;
                                ...
                                .action
                                    ...
                                    .item
                                        ...
                                        span
                                            ...
                                            &.icon
                                                background url("~@img/template1/center/edit.png") center / contain no-repeat
                                                width 18px
                                                height 18px
