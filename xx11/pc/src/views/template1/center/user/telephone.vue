<template lang="pug">
    .telephone
        .info
            ...
            .submit-btn.ok(v-if="step==1 && userInfo.mobile",@click="changeStep(2)") 去验证
            .submit-btn.ok(v-if="step==1 && !userInfo.mobile",@click="changeStep(2)") 去绑定
            .common-btn(v-if="step==2",@click="submit()" :disabled="!curBut" :class="[{ 'ok': subFlag }]") 保存
            .submit-btn.ok(v-if="step==3",@click="changeStep(2)") 修改手机号
...
import {resNum, resZM} from '@m/utils' // 工具类
...
.telephone
    ...
    .info
        ...
        .detail-con
            ...
            .img
                margin 0 auto
                background url("~@img/template1/center/shouj.png") center no-repeat
                width 348px
                height 345px
