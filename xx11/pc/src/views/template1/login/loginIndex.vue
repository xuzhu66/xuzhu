...
import Login from '@/views/template1/login/loginAcount'; // 登录
import Reg from '@/views/template1/login/registIndex'; // 注册
import ForgetPwd from '@/views/template1/login/forgetPwd'; // 忘记密码
import UpdatePwd from '@/views/template1/login/updatePwd'; // 修改密码
import LoginVerif from '@/views/template1/login/loginPhoneCode'; // 验证码登录
...
export default {
    ...
    data() {
        return {
            isReq: false, // 请求是否完成
            flog: require('@img/template1/home/foot_blogo.png'),
            curtit: "欢迎登录", // 当前标题
            menu: [
                {
                    name: '登录',
...
@import '~@styl/template1/modules/login.styl'
