...
import RegAcount from '@/views/template1/login/registAcount'; // 用户账号注册
import RegPhone from '@/views/template1/login/registPhone'; // 手机号码注册
import RegVerif from '@/views/template1/login/registPhoneCode'; // 验证码注册
export default {
    name: 'Register', // 注册
    components: {
...
.register
    ...
    .reg-qmenu
        ...
        li
            ...
            &:nth-child(1)
                ...
                &:after
                    ...
                    right -22px
                    top: 3px;
                    border_com(1px, solid, border35, left)
                    height: 16px;
                    position absolute
        ...
        &:before
            ...
            left 0px
            bottom: -8px;
            border_com(3px, solid, border33, bottom)
            height: 1px;
            width 60px
            position absolute
