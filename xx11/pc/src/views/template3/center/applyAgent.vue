        ...
        .user-list
            ...
            .item
                ...
                .icon
                    ...
                    &.all
                        background url("~@img/template3/center/daili.png") center no-repeat

                    &.week
                        background url("~@img/template3/center/chukuan.png") center no-repeat

                    &.yesterday
                        background url("~@img/template3/center/xinzeng.png") center no-repeat
