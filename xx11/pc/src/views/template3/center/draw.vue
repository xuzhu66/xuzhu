...
import passWordDialog from "@/views/template3/center/passWordDialog";
import usdtDialog from "@/views/template3/center/user/usdtDialog";
import bankDialog from "@/views/template3/center/user/bankDialog";
export default {
    name: "draw",
    components: {
        comDialog,
            ...
            .form
               .title-usdt
                ...
                .form-item
                    ...
                    line-height 68px
                    border-radius: 5px;
                    border_all(1px, solid, border_hui1);
                    margin-bottom 20px
                    display flex
                    flex-direction row
                    flex-wrap nowrap
