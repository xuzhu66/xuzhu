        ...
        .info
            .info-con
                ...
                .form
                    ...
                    .form-item.dialog-con.common-down(@click="toggleDialog",:class="showDateDialogFlag?'active':''")
                        .lable 转出线路:
                    ...
                    .form-item.dialog-con.common-down(@click="toggleDialog2",:class="showDateDialogFlag2?'active':''")
                        .lable 转入线路:
                ...
                .common-btn.big(@click="submitFun" ,:class="subFlag?'ok':'hidden'") 立即转账
        ...
        comDialog(:show-footer='false',:show="showJumpDialog",@on-cancel="closeJumpDialog")
            ...
            div.dialog-con(slot="default")
                .jump-con
                    ...
                    .btns-con
                        .common-btn.hidden(@click="closeJumpDialog",:class="tempTurnIn.lineId ==0?'ok':''") 我知道了
