            ...
            .form
                ...
                .user-icon
                    ...
                    &:after
                        content: "";
                        display: block;
                        background url("~@img/template3/center/edit.png") center no-repeat
                        width 20px
                        height 21px
                        position absolute
                        top 50%
                ...
                .tel-icon
                    ...
                    &:after
                        content: "";
                        display: block;
                        background url("~@img/template3/center/tel.png") center no-repeat
                        width 17px
                        height 24px
                        position absolute
                        top 50%
                    ...
                    &.checked:after
                        background url("~@img/template3/center/renz.png") center no-repeat
