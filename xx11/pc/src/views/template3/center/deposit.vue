                            ...
                            li
                                ...
                                &.active
                                    ...
                                    &:after
                                        ...
                                        bottom 0px
                                        right 0px
                                        background url("~@img/template3/center/duihao.png") center no-repeat
                                ...
                                .icon
                                    ...
                                    &.wechat, &.weChat, &.wechat_h5, &.weChat_h5
                                        background url("~@img/template3/center/wechat.svg") center / contain no-repeat

                                    &.alipay, &.alipay_h5
                                        background url("~@img/template3/center/zfb.svg") center / contain no-repeat

                                    &.bank_card
                                        background url("~@img/template3/center/card.svg") center / contain no-repeat

                                    &.ebank_card
                                        background url("~@img/template3/center/deposit/ebankcard.svg") center / contain no-repeat

                                    &.wechat_card
                                        background url("~@img/template3/center/deposit/wechatcard.svg") center / contain no-repeat

                                    &.alipay_card
                                        background url("~@img/template3/center/deposit/alipaycard.svg") center / contain no-repeat

                                    &.usdt_pay
                                        background url("~@img/template3/center/deposit/virtual.svg") center / contain no-repeat

                                    &.cloud_flash
                                        background url("~@img/template3/center/deposit/cloudpay.png") center / contain no-repeat

                                    &.ebank
                                        background url("~@img/template3/center/deposit/ebank.svg") center / contain no-repeat
                                ...
                                li
                                    ...
                                    &.active
                                        ...
                                        &:after
                                            after()
                                            display block
                                            background url("~@img/template3/center/right.svg") center / contain no-repeat
                                            width 18px
                                            height 18px
                                            right 10px
                                            top 50%
                                    ...
                                    &.active-hui
                                        ...
                                        &:after
                                            after()
                                            display block
                                            background url("~@img/template3/center/hui.svg") center / contain no-repeat
                                            width 18px
                                            height 18px
                                            right 10px
                                            top 50%
    ...
    .step-con
        ...
        .traver-time-com
            ...
            .outer
                width: 240px;
                height: 240px;
                background url("~@img/template3/center/deposit/time.png") center / contain no-repeat
                display flex
                flex-direction row
                justify-content center
                align-items center
