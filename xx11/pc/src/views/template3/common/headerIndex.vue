        ...
        .w1200.flex-box
            ...
            .login-obj
                ...
                .no-login-con(v-show="!userId")
                    .no-login-flow
                        .btn-regist(@click="showReg") 注册
                        .btn-login(@click="showLogin") 登录
                        .btn-con
                            .btn-empty
                            .btn-kind
                    // 遮罩--做按钮来回的效果 , 点击代替登录;
                    .masking(@click="showLogin")
...
import drawCenter from "@/views/template3/center/drawCenter";
            ...
            .login-con
                ...
                .login-right
                    ...
                    .login-r-top
                        ...
                        //.vip-1
                        //    background-image url('~@img/template3/comm/vip0.png')
                        //
                        //.vip-2
                        //    background-image url('~@img/template3/comm/vip1.png')
                        //
                        //.vip-3
                        //    background-image url('~@img/template3/comm/vip2.png')
                        //
                        //.vip-4
                        //    background-image url('~@img/template3/comm/vip3.png')
                        //
                        //.vip-5
                        //    background-image url('~@img/template3/comm/vip4.png')
                        //
                        //.vip-6
                        //    background-image url('~@img/template3/comm/vip5.png')
                        //
                        //.vip-7
                        //    background-image url('~@img/template3/comm/vip6.png')
                ...
                .login-user
                    ...
                    width 60px
                    height 60px
                    background url("~@img/template3/logo/logo.png") center / contain no-repeat
                    ...
                    .center-flow
                        ...
                        .center-cont
                            ...
                            .center-item
                                ...
                                &.down
                                    border_com(1px, solid, border_common, top)
                                    width: 330px;
                                    height: 60px;
                                    flexcon()
                                    font-size: 14px;
            ...
            .no-login-con
                ...
                .no-login-flow
                    ...
                    .btn-con
                        ...
                        width 200px
                        flexcon()
                        border_all(1px, solid, btn_border_ok)
                        border-radius 24px
                        .btn-empty
                            cursor()
                            flexcon()
                        ...
                        .btn-kind
                            ...
                            font-size: 20px;
                            border-radius 24px
                            border_com(1px, solid, btn_border_ok, bottom)
                            bg_img_linear(linear_common)
                            font-size: 20px;
                            font_color(fc6)
                            transition all .3s ease-in-out
